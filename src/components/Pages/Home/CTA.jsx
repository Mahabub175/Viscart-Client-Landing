...
const CTA = () => {
  return (
    <section
      ...
      className="bg-cover bg-no-repeat bg-center my-container text-white my-10 lg:my-20 p-20 lg:p-44 rounded-xl"
    >
      <div className="lg:px-10 flex flex-col lg:flex-row justify-between items-center gap-10 text-center lg:text-start">
